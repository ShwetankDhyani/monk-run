/**
 * Expedition globe for the landing hero.
 * Brass wireframe + corps-green land band + wall ring — monk.run worldwide rounds.
 */
  ...
  return (
    <div className={`temple-globe ${className}`} aria-hidden="true">
      <svg className="temple-globe-svg" viewBox="0 0 200 200" fill="none">
        ...
        {/* Wall ring — distant rampart frame */}
        <circle cx="100" cy="100" r="96" stroke="#8b7355" strokeWidth="0.8" opacity="0.22" strokeDasharray="4 6" />
        ...
        <circle cx="100" cy="100" r="72" stroke="#6b9a62" strokeWidth="1.15" opacity="0.55" />
        ...
        <g clipPath="url(#tg-clip)">
          ...
          <ellipse cx="100" cy="100" rx="24" ry="72" stroke="#6b9a62" strokeWidth="0.7" opacity="0.26" />
        ...
        {/* Wing chevron homage (original geometry) */}
        <path d="M100 18 L118 42 L100 34 L82 42 Z" fill="#7ec89a" opacity="0.18" />
        <path d="M100 22 L112 40 L100 33 L88 40 Z" stroke="#6b9a62" strokeWidth="0.8" opacity="0.45" />
