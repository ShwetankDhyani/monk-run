...
export const COPY = {
  ...
  landing: {
    ...
    openTemple: 'Create room',
    pinLabel: 'Room PIN',
    stepInside: 'Join room',
    dismiss: 'Dismiss',
    howTo: 'How to play',
    settings: 'Settings',
    privacy: 'Privacy',
  ...
  leaderboard: {
    ...
    fame: 'Hall of Fame',
    shame: 'Hall of Shame',
    highestScore: 'Most round wins',
    highestScoreHint: 'Top 5 by rounds won (closest each round)',
    closestGuess: 'Closest guess',
    closestGuessHint: 'Top 5 nearest pins',
    lowestScore: 'Fewest round wins',
    lowestScoreHint: 'Top 5 with the fewest round wins',
  ...
  reveal: {
    ...
    modeDistance: 'Closest wins',
    modePoints: 'Classic points',
    next: 'Next place',
  ...
  loading: {
    ...
    scoring: 'Measuring distances…',
    scoringTitle: 'Closest wins',
    scoringRetry: 'Retry scoring',
  },
